...
Sys.Extended.UI.AjaxFileUpload.ProcessorHtml5 = function (control, elements) {
    ...
    this.upload = function (fileItem) {
        ...
        xhrReq.open("POST.html", control._uploadUrl + '?contextKey=' + control._contextKey + '&fileId=' + id + '&fileName=' + fileName + '&chunked=' + (chunked ? "true" : "false") + '&firstChunk=' + firstChunk + '&storeToAzure=' + control.get_storeToAzure() + '&acn='+control.get_azureContainerName(), true);
