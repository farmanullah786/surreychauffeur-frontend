...
Sys.Extended.UI.AjaxFileUpload.Processor = function (control, elements) {
    ...
    this.cancelUpload = function () {
        ...
        xhr.open("POST.html", '?contextKey=' + control._contextKey + "&cancel=1&guid=" + control._currentFileId, true);
    ...
    this.pollingServerProgress = function (value) {
        ...
        xhrPoll.open("GET.html", '?contextKey=' + control._contextKey + "&poll=1&guid=" + control._currentFileId, true);
        xhrPoll.send(null);
    };
