...
const SignUpForm = (props) => {
  return (
    <form onSubmit={props?.handleSubmit(props?.postRequestToSignUpForm)}>
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <input
              ...
              {...props?.register("re_email", {
                ...
                validate: (value) => {
                  ...
                  return email === value || "Email should be same";
                },
              })}
            />
            <i className="glyphicon glyphicon-envelope form-control-feedback glyphiconalign"></i>
          ...
          <div className="text-left form-group has-feedback">
            ...
            <span
              ...
              style={{
                color: "Red",
                display: props?.errors?.password ? "block" : "none",
              }}
            >
              *
            </span>
          ...
          <div className="text-left form-group has-feedback">
            <input
              ...
              autoComplete="off"
              type={props?.showPassword ? "text" : "password"}
              {...props?.register("password2", { required: true })}
            />
            <i className="glyphicon glyphicon-lock form-control-feedback glyphiconalign"></i>
            <span
              ...
              style={{
                color: "Red",
                display: props?.errors?.password2 ? "block" : "none",
              }}
            >
              *
            </span>
          ...
          <div className="text-left form-group has-feedback">
            <div className="sign-check">
              <input
                ...
                onClick={() => {
                  props?.setShowPassword(props?.showPassword ? false : true);
                }}
              />
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          ...
          <div className="text-left form-group has-feedback">
            <p>
              This information will auto-fill on to the booking form when each
          ...
          <div className="text-left form-group has-feedback">
            ...
            <span
              ...
              style={{
                color: "Red",
                display: props?.errors?.first_name ? "block" : "none",
              }}
            >
              *
            </span>
          ...
          <div className="text-left form-group has-feedback">
            ...
            <span
              ...
              style={{
                color: "Red",
                display: props?.errors?.last_name ? "block" : "none",
              }}
            >
              *
            </span>
          ...
          <div className="text-left form-group has-feedback">
            ...
            >
              ...
              <option value="243">Congo, Dem. Republic 243</option>
              ...
              <option value="687">New Caledonia (French) 687</option>
              ...
              <option value="1-340">Virgin Islands (USA) 1-340</option>
            ...
            <span
              ...
              style={{
                color: "Red",
                display: props?.errors?.country ? "block" : "none",
              }}
            >
              *
            </span>
          ...
          <div className="text-left form-group has-feedback">
            ...
            <span
              ...
              style={{
                color: "Red",
                display: props?.errors?.phone ? "block" : "none",
              }}
            >
              *
            </span>
