                    ...
                    <div class="stm_rent_car_form">
                      <div name="book-taxi" class="book-taxi-form">
                        ...
                        <div class="row">
                          ...
                          <div
                            class="form-group col-md-8 col-sm-8"
                            style={{
                              marginBottom: "4px",
                              paddingBottom: "4px",
                            }}
                          >
                            ...
                            >
                              ...
                              <option value="4138">
                                Newhaven Port BN9 0DF
                              </option>
                              <option value="4139">
                                Ramsgate Port CT11 9FT
                              </option>
                              <option value="4140">
                                Weymouth Harbour DT4 8DX
                              </option>
                              <option value="4141">
                            ...
                            >
                              ...
                              <option value="6127">
                                Cardiff Central CF10 1EP
                              </option>
                              <option value="4229">
                                Carpenders Park WD19 7DT
                              </option>
                              <option value="4231">
                              ...
                              <option value="4256">
                                City Thameslink EC4M 7JH
                              </option>
                              <option value="4257">
                                Clapham Common SW4 7AJ
                              </option>
                              <option value="4258">
                              ...
                              <option value="4260">
                                Clapham North SW4 7TS
                              </option>
                              <option value="4261">
                                Clapham South SW12 9DU
                              </option>
                              ...
                              <option value="4267">
                                Colliers Wood SW19 2HR
                              </option>
                              <option value="4268">
                                Coulsdon South CR5 3EA
                              </option>
                              <option value="4269">
                              ...
                              <option value="4281">
                                Dagenham Dock RM9 6RA
                              </option>
                              <option value="4282">
                                Dagenham East RM10 8AA
                              </option>
                              <option value="4283">
                                Dagenham Heathway RM9 5AN
                              </option>
                              <option value="4284">
                                Dalston Junction E8 3DL
                              </option>
                              <option value="4285">
                                Dalston Kingsland E8 2JS
                              </option>
                              ...
                              <option value="4310">
                                Edgware Road (Circle/District/Hammersmith and
                                City) NW1 5DH
                              </option>
                              <option value="4309">
                              ...
                              <option value="4318">
                                Elverson Road SE8 4LA
                              </option>
                              <option value="4319">Embankment WC2N 6NS</option>
                              <option value="4320">
                                Emerson Park RM11 2JR
                              </option>
                              <option value="4321">
                                Enfield Chase EN2 7AA
                              </option>
                              ...
                              <option value="4337">
                                Finchley Central N3 2RY
                              </option>
                              <option value="4339">
                                Finchley Road and Frognal NW3 5HT
                              </option>
                              <option value="4338">
                                Finchley Road NW6 3BS
                              </option>
                              ...
                              <option value="4350">
                                Golders Green NW11 7RN
                              </option>
                              <option value="4351">
                                Goldhawk Road W12 8EG
                              </option>
                              <option value="4352">
                                Goodge Street W1T 2HF
                              </option>
                              ...
                              <option value="4421">
                                Imperial Wharf SW6 2HA
                              </option>
                              <option value="4422">
                                Island Gardens E14 3FA
                              </option>
                              ...
                              <option value="4445">
                                Knightsbridge SW3 1ED
                              </option>
                              <option value="4446">Knockholt TN14 7HR</option>
                              <option value="4447">
                                Ladbroke Grove W10 6HJ
                              </option>
                              <option value="4448">Ladywell SE13 7XB</option>
                              <option value="4449">
                                Lambeth North SE1 7XG
                              </option>
                              <option value="4450">
                                Lancaster Gate W2 4QH
                              </option>
                              ...
                              <option value="4479">
                                Mill Hill East NW7 1BS
                              </option>
                              <option value="4480">
                                Mitcham Eastfields CR4 2ND
                              </option>
                              <option value="4481">
                                Mitcham Junction CR4 4HN
                              </option>
                              ...
                              <option value="4494">
                                New Beckenham BR3 1QW
                              </option>
                              <option value="4496">
                                New Cross Gate SE14 6AR
                              </option>
                              ...
                              <option value="4575">
                                Royal Victoria E16 1DE
                              </option>
                              <option value="4577">
                                Ruislip Gardens HA4 6LG
                              </option>
                              <option value="4576">Ruislip HA4 8LD</option>
                              <option value="4578">
                                Ruislip Manor HA4 9AA
                              </option>
                              <option value="4579">
                                Russell Square WC1N 1LG
                              </option>
                              ...
                              <option value="4598">
                                South Croydon CR2 7PA
                              </option>
                              <option value="4599">South Ealing W5 4QB</option>
                              <option value="4600">
                                South Hampstead NW8 0DJ
                              </option>
                              <option value="4601">South Harrow HA2 8HN</option>
                              <option value="4602">
                                South Kensington SW7 2NB
                              </option>
                              <option value="4603">South Kenton HA9 8QT</option>
                              <option value="4604">
                                South Merton SW20 9JT
                              </option>
                              <option value="4605">South Quay E14 9SH</option>
                              <option value="4606">
                                South Ruislip HA4 6TP
                              </option>
                              <option value="4607">
                                South Tottenham N15 6ND
                              </option>
                              <option value="4608">
                                South Wimbledon SW19 1DE
                              </option>
                              <option value="4609">
                                South Woodford E18 1JJ
                              </option>
                              ...
                              <option value="4622">
                                St. Johns Wood NW8 6DN
                              </option>
                              <option value="4623">St. Pauls EC2V 6AA</option>
                              <option value="4624">
                                Stamford Brook W6 0SB
                              </option>
                              <option value="4625">
                                Stamford Hill N16 5AG
                              </option>
                              ...
                              <option value="4644">
                                Sundridge Park BR1 3TR
                              </option>
                              <option value="4645">Surbiton KT6 4PE</option>
                              <option value="4646">
                                Surrey Quays SE16 2UE
                              </option>
                              <option value="4648">
                                Sutton Common SM1 3HY
                              </option>
                              <option value="4647">Sutton SM1 1JA</option>
                              <option value="4649">
                                Swiss Cottage NW3 6HY
                              </option>
                              <option value="4651">
                                Sydenham Hill SE21 7HW
                              </option>
                              ...
                              <option value="4657">
                                Thames Ditton KT7 0PA
                              </option>
                              <option value="4658">
                                Theobalds Grove EN8 7BG
                              </option>
                              <option value="4659">
                                Theydon Bois CM16 7EU
                              </option>
                              <option value="4660">
                                Thornton Heath CR7 8RX
                              </option>
                              ...
                              <option value="4679">
                                Upper Holloway N19 4DJ
                              </option>
                              <option value="4680">
                                Upper Warlingham CR3 0EP
                              </option>
                              ...
                              <option value="4691">
                                Wandsworth Road SW8 4PA
                              </option>
                              <option value="4692">
                                Wandsworth Town SW18 1SU
                              </option>
                              ...
                              <option value="4703">
                                Wembley Central HA9 6AG
                              </option>
                              <option value="4704">Wembley Park HA9 9AA</option>
                              <option value="4705">
                                Wembley Stadium HA9 8BQ
                              </option>
                              ...
                              <option value="4717">
                                West India Quay E14 4ED
                              </option>
                              <option value="4718">
                                West Kensington W14 9NL
                              </option>
                              <option value="4719">
                              ...
                              <option value="4733">
                                Whyteleafe South CR3 0BD
                              </option>
                              <option value="4734">
                                Willesden Green NW2 4QT
                              </option>
                              <option value="4735">
                                Willesden Junction NW10 4RA
                              </option>
                              <option value="4737">
                                Wimbledon Chase SW20 8DB
                              </option>
                              <option value="4738">
                                Wimbledon Park SW19 7DZ
                              </option>
                              <option value="4736">Wimbledon SW19 1PS</option>
                              <option value="4739">
                                Winchmore Hill N21 3NG
                              </option>
                              ...
                              <option value="4744">
                                Woodgrange Park E7 8AA
                              </option>
                              <option value="4745">
                                Woodmansterne CR5 3HS
                              </option>
                              <option value="4746">
                                Woodside Park N12 8SE
                              </option>
                              <option value="4747">
                        ...
                        <div class="row">
                          <div class="form-group col-md-12 frmcheckbox">
                            <input
                        ...
                        <div class="row">
                          ...
                          >
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div id="datepicker-outer-l" class="input-group">
                                <input
                          ...
                          >
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div id="datepicker-outer-r" class="input-group">
                                <input
